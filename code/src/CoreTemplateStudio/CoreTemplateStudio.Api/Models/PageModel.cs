...
namespace CoreTemplateStudio.Api.Models
{
    public class PageModel
    {
        ...
        public PageModel(Page page, params Framework[] supportedFrameworks)
        {
            this.Name = EnumerablesHelper.GetDisplayName(page);
            this.Description = EnumerablesHelper.GetDescription(page);
