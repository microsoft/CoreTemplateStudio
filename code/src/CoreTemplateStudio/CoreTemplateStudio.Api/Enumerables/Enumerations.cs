...
namespace CoreTemplateStudio.Api.Enumerables
{
    ...
    public enum ShortFramework
    {
        ...
        [Description("A JavaScript framework that only supports singlepage websites cause that's radder")]
        SPJS,
        [DisplayName("MultiPageJS")]
        [Description("A JavaScript framework that only supports multipage websites cause that's rad")]
        MPJS,
    }
}
